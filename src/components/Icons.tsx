...
export function BaselineIcon({ size = 24 }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function HeartIcon({ size = 24, className }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function YoutubeIcon({ size = 24, className }: Props) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-brand-youtube ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export function TiktokIcon({ size = 24, className }: Props) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`icon icon-tabler icons-tabler-outline icon-tabler-brand-tiktok ${className}`}
    >
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
